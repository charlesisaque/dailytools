...
const cards = [
  { title: "Controle de gastos", description: "Monitore suas despesas", icon: <FaMoneyBillWave size={30} />, gradient: "from-green-400 to-green-600" },
  { title: "Investimentos", description: "Acompanhe seus investimentos", icon: <FaChartLine size={30} />, gradient: "from-teal-400 to-teal-600" },
];

const Financas: React.FC = () => {
  return (
    <Page title="Finanças" description="Gerencie seu dinheiro e investimentos">
